...
| 28 | Invoice PDF + email send (W4) | core | claimed 2026-07-20 | **this tab** | Reuses the slice-25 Resend seam (feature "invoice" pre-whitelisted). PDF via pure-JS lib (works in the desktop standalone). sent_at tracking, not a status change. |
