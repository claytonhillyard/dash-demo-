...
| 30 | WinJewel invoice history import (W6) | aiya-jewelry | claimed 2026-07-20 | **this tab** | Depends on 26/27/29 (all shipped). Reuses the slice-26 CSV wizard/preset machinery; idempotent on invoices_org_number_unique; payments via slice-29 rows. |
