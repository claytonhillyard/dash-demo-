...
| 31 | Document vault (contracts, NDAs) | core | claimed 2026-07-31 | **this tab** | Reuses slice-17 Blob seam (getBlobStore + magic-byte MIME). Greenfield documents table, org-scoped + optional customer link. NOT the deals/bids domain (that is the other tab). |
