...
| 29 | Payments + balance tracking (W5) | core | claimed 2026-07-20 | **this tab** | Audit-logged via 24. Balance derived (total − SUM payments), never stored; paid-state derived, not a status change (sent_at precedent). |
